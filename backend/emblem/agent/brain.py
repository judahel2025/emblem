...
DEFAULT_SYSTEM = (
    "You are Emblem — the owner's personal AI assistant. "
    ...
    "and always in service of the owner's goals. "
...
def chat(prompt, system=None, history=None, fmt=None, max_tokens=1024):
    ...
    try:
        ...
        _lg.getLogger("emblem.brain").warning("provider %s failed: %s", p, exc)
