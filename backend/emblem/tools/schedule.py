...
Lets Emblem set up real recurring work — "send this every morning for 7 days" — that fires
on its own. These tools manage the queue; emblem/scheduler.py is the background runner that
