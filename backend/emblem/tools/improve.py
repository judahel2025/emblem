"""Self-improvement log — when Emblem hits a limit or spots something she should do better,
it gets recorded here so the owner can see exactly what to teach or upgrade.
"""
...
@tool("improve.log", Tier.SAFE, "Log something Emblem needs improved",
