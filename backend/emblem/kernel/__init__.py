"""Emblem Security Kernel -- the foundation every capability plugs into.

Public surface:
    from emblem.kernel import boot, execute_tool, tool, Tier
    from emblem.kernel import approvals, audit, config, vault, snapshots
