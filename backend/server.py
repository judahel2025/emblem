"""Launch the Emblem kernel-backed API.

    C:\\EMBLEM\\.venv\\Scripts\\python.exe backend\\server.py
...
if __name__ == "__main__":
    ...
    uvicorn.run("emblem.api.app:app", host="0.0.0.0", port=8788, reload=False)
