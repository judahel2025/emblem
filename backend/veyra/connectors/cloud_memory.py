"""Cloud-persistent memory — Veyra remembers facts and context across sessions and
devices, stored in the Veyra Supabase. Keyword + recency recall. The agent loop injects
