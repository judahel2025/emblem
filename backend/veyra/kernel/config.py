...
FULL_AUTO_ALLOW = frozenset({
    "email.send_to",           # one-off emails Judah dictates
    "estoppel.send_mail",      # one-off email from Estoppel address
    "estoppel.support_reply",  # reply to a specific support message
