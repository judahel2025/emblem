...
__name(voiceRelay, "voiceRelay");

// src/cron.ts
async function heartbeat(_env) {
}
...
var src_default = {
  fetch: app.fetch,
  scheduled: /* @__PURE__ */ __name((_controller, env, ctx) => ctx.waitUntil(heartbeat(env)), "scheduled")
};
...
// .wrangler/tmp/bundle-o9qkgi/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-o9qkgi/middleware-loader.entry.ts
